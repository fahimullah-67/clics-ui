            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-colors ${
                  activeTab === tab.id ? "bg-blue-100 text-blue-700 font-semibold" : "text-gray-700 hover:bg-gray-100"
                }`}
              >
            ...
            <>
              ...
              <Card className="p-6">
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  />
                  <div>
                    <label htmlFor="twoFactor" className="font-medium text-gray-900 cursor-pointer">
                ...
                {securitySettings.twoFactorAuth && (
                  <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-800">
                      Two-factor authentication is enabled. You'll receive a code via SMS or email during login.
                    </p>
                  </div>
                )}
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  {activities.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-4 p-3 border-l-4 border-l-blue-500">
                      <div
              ...
              <Card className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        />
                        <div>
                          <label htmlFor="emailNotif" className="font-medium text-gray-900 cursor-pointer">
                            Email Notifications
                          </label>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        />
                        <div>
                          <label htmlFor="smsNotif" className="font-medium text-gray-900 cursor-pointer">
                            SMS Notifications
                          </label>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        />
                        <div>
                          <label htmlFor="pushNotif" className="font-medium text-gray-900 cursor-pointer">
                            Push Notifications
                          </label>
                  ...
                  <div className="border-t pt-6">
                    <h3 className="font-semibold text-gray-900 mb-4">What to notify me about</h3>
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        <Checkbox
                          id="loanAlerts"
                          checked={preferences.loanAlerts}
                          onChange={(e) => setPreferences({ ...preferences, loanAlerts: e.target.checked })}
                        />
                        <div>
                          <label htmlFor="loanAlerts" className="font-medium text-gray-900 cursor-pointer">
                            Loan Status Updates
                          </label>
                          <p className="text-sm text-gray-600">Application status, approvals, and EMI reminders</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        <Checkbox
                          ...
                          onChange={(e) => setPreferences({ ...preferences, schemeUpdates: e.target.checked })}
                        />
                        <div>
                          <label htmlFor="schemeUpdates" className="font-medium text-gray-900 cursor-pointer">
                            Investment Scheme Updates
                          </label>
                          <p className="text-sm text-gray-600">New schemes and interest rate changes</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Special offers and product recommendations</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <label htmlFor="personalization" className="font-medium text-gray-900 cursor-pointer">
                            Personalization
                          </label>
                  ...
                  <div className="border-t pt-6">
                    ...
                    <p className="text-gray-600 mb-4">Manage your account data and privacy</p>
