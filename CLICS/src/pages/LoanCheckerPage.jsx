...
export default function LoanCheckerPage() {
  ...
  const calculateEligibility = () => {
    ...
    const monthlyLoanPayment =
      loanAmount / (Number.parseFloat(formData.loanTenure) * 12);
    ...
    setEligibilityResult({
      ...
      emi: (
        approvedAmount /
        (Number.parseFloat(formData.loanTenure) * 12)
      ).toFixed(2),
    });
  };
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Check your loan eligibility in 3 simple steps
        </p>
      </div>
